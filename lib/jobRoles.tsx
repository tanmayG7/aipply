...
export const roleBasedSkills: Record<string, string[]> = {
  "Product Manager": [
    "Product Strategy",
    "Product Roadmapping",
    "Agile Methodology",
  ...
  "Booking Manager": [
    ...
    "Time Management",
    "Negotiation Skills",
    "Proficiency in Booking Software",
  ],
  Bookkeeper: [
    "Bookkeeping",
    "Accounts Payable",
  ...
  "Datacenter Specialist": [
    ...
    "Azure)",
    "Storage Systems Management (SAN/NAS)",
  ...
  Hydrologist: [
    ...
    "Hydrologic Software Proficiency",
  ],
  "IT Analyst": [
  ...
  "Infrastructure Engineer": [
    ...
    "Monitoring and Logging (Nagios/Zabbix/Prometheus)",
  ...
  Optometrist: [
    ...
    "Patient Counseling",
    "Ophthalmic Equipment Proficiency",
    "Glaucoma Management",
    "Refraction Testing",
    "Attention to Detail",
    "Interpersonal Communication",
  ...
  Pipefitter: [
    ...
    "Threading pipe",
    "Pipe cutting",
    "Valve and fittings installation",
    "Hydrostatic testing",
    "Rigging",
    "Safety compliance",
  ],
  ...
  Podiatrist: [
    "Foot and ankle anatomy knowledge",
    "Diabetic foot care",
  ...
  "Production Assistant": [
    ...
    "Multitasking",
    "Equipment Handling",
    "Basic Video/Audio Production Knowledge",
  ],
  "Production Manager": [
    "Production Planning",
    "Inventory Management",
