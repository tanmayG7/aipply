...
const UploadCv: React.FC<UploadCvProps> = ({ isEditing, userDetails }) => {
  ...
  return (
    <div style={{ border: '2px solid red', width: '100%', backgroundColor: 'blue', minHeight: '100px', color: 'white', padding: '20px' }}>
      DEBUG: This should be full width with red border and blue background. 
      <br />
      isEditing: {isEditing ? 'true' : 'false'}
      <br />
      If this appears narrow with gaps on sides, the issue is in parent containers (editProfile.tsx or page.tsx)
    </div>
  );
};
