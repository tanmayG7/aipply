            ...
            <nav className="flex items-center gap-10">
              ...
              >
                ...
                {isResourcesDropdownOpen && (
                  <div
                    className="absolute z-[9999] bg-gradient-to-b from-[#4c4088] to-[#7030ca] shadow-lg rounded-lg border border-opacity-[10%] mt-12 left-1/2 transform -translate-x-1/2 w-[275px] grid w-grid-cols-1"
                    onMouseEnter={() => setIsResourcesDropdownOpen(true)}
                    onMouseLeave={() => setIsResourcesDropdownOpen(false)}
                  >
