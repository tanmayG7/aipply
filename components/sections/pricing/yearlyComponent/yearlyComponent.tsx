// components/sections/pricing/yearlyComponent/yearlyComponent.tsx (FEATURES ALWAYS VISIBLE)
...
const YearlyComponent = () => {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      console.log('🚀 Initiating Razorpay yearly subscription...');
      ...
      console.log('📄 Yearly subscription created:', subscriptionData.subscriptionId);
      ...
      const options = {
        ...
        name: 'AiPply Premium',
        description: 'Yearly Premium Subscription - ₹4188',
        
        handler: function (response: any) {
          console.log('✅ Yearly payment successful:', response);
          setPaymentSuccess(true);
          
          alert('🎉 Payment successful! Your yearly premium subscription is now active. Welcome to AiPply Premium!');
        ...
        modal: {
          ondismiss: function() {
            console.log('❌ Yearly payment modal closed by user');
      ...
      rzp.on('payment.failed', function (response: any) {
        console.error('❌ Yearly payment failed:', response.error);
      ...
      console.error('❌ Yearly subscription creation failed:', error);
              ...
              <div className={showRazorpay ? 'block space-y-3' : 'hidden'}>
                ...
                >
                  {isCreatingSubscription ? 'Creating...' : 
                   ...
                   razorpayLoaded ? 'Pay ₹4188' : 'Loading...'}
                </button>
