...
export default function ProfileSetup() {
  ...
  const validatePage = () => {
    ...
    if (page === 1) {
      ...
      newErrors.mobileNumber = !formData.mobileNumber || !phoneNumberRegex.test(formData.mobileNumber);
      ...
      newErrors.currentCTC = !formData.currentCTC || !ctcRegex.test(formData.currentCTC);
    } else if (page === 5) {
      newErrors.expectedCTC = !formData.expectedCTC || !ctcRegex.test(formData.expectedCTC);
    } else if (page === 6) {
      newErrors.linkedinProfile = !formData.linkedinProfile || !linkedinRegex.test(formData.linkedinProfile);
    }
    setErrors(newErrors);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Set up your profile to apply for jobs on Aipply." />
      </Head>
                ...
                {page === 1 && (
                  <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                      ...
                      />
                      {errors.mobileNumber && (
                        <p className="text-red-500">Mobile Number is required and should be in the format +91-XXXXXXXXXX</p>
                      )}
                    </div>
                    <div className="grid gap-2">
                ...
                {page === 4 && (
                  <div className="grid gap-6">
                    <div className="grid gap-2">
                      ...
                      />
                      {errors.currentCTC && (
                        <p className="text-red-500">Current CTC is required and should be in the format X LPA</p>
                      )}
                      <p className="text-text-sm-regular font-inter text-[#94969C]">
                ...
                {page === 5 && (
                  <div className="grid gap-6">
                    <div className="grid gap-2">
                      ...
                      />
                      {errors.expectedCTC && (
                        <p className="text-red-500">Expected CTC is required and should be in the format X LPA</p>
                      )}
                      <p className="text-text-sm-regular font-inter text-[#94969C]">
                        Ex: 10LPA, 20LPA, 30LPA.
                      </p>
                  ...
                  <div className="grid gap-6">
                    <div className="grid gap-2">
                      ...
                      {errors.linkedinProfile && (
                        <p className="text-red-500">
                          LinkedIn Profile is required and should be a valid URL starting with https://
                        </p>
                      )}
                    </div>
                  </div>
