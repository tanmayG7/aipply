                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                      <div className="text-center p-2 bg-gray-800 rounded">
                        ...
                        <div className="text-lg font-bold text-white">{debugInfo.distribution.jobMap}</div>
                      </div>
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <div className="text-xs text-gray-400">Text Search</div>
                        <div className="text-lg font-bold text-white">{debugInfo.distribution.textSearch}</div>
                      </div>
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <div className="text-xs text-gray-400">Skills Match</div>
                        <div className="text-lg font-bold text-white">{debugInfo.distribution.skillsMatching}</div>
                      </div>
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <div className="text-xs text-gray-400">Fuzzy Scoring</div>
                        <div className="text-lg font-bold text-white">{debugInfo.distribution.fuzzyScoring}</div>
                      </div>
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <div className="text-xs text-gray-400">Last Resort</div>
                        <div className="text-lg font-bold text-white">{debugInfo.distribution.lastResort}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      <div className="text-center p-2 bg-green-900/30 border border-green-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-green-300">{debugInfo.matchingStats.exactMatches}</div>
                      </div>
                      <div className="text-center p-2 bg-blue-900/30 border border-blue-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-blue-300">{debugInfo.matchingStats.fuzzyMatches}</div>
                      </div>
                      <div className="text-center p-2 bg-purple-900/30 border border-purple-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-purple-300">{debugInfo.matchingStats.titleMatches}</div>
                      </div>
                      <div className="text-center p-2 bg-orange-900/30 border border-orange-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-orange-300">{debugInfo.matchingStats.enhancedMatches}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div className="text-center p-2 bg-red-900/30 border border-red-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-red-300">{debugInfo.fuzzyScoreDistribution.high}</div>
                      </div>
                      <div className="text-center p-2 bg-yellow-900/30 border border-yellow-500/30 rounded">
                        ...
                        <div className="text-lg font-bold text-yellow-300">{debugInfo.fuzzyScoreDistribution.medium}</div>
                      </div>
                      <div className="text-center p-2 bg-gray-800 border border-gray-600 rounded">
                        <div className="text-xs text-gray-400">Low (<0.5)</div>
                        <div className="text-lg font-bold text-gray-300">{debugInfo.fuzzyScoreDistribution.low}</div>
                      </div>
                    </div>
                  </div>
