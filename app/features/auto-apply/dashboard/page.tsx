                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span>
                          {stats.todayApplications}/{autoApplySettings.maxApplicationsPerDay}
                        </span>
                      </div>
                      <Progress
                        value={(stats.todayApplications / autoApplySettings.maxApplicationsPerDay) * 100}
                        className="mt-2"
                      />
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <p>{autoApplySettings.jobTitles?.join(", ") || "None"}</p>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-300">Locations</p>
                        <p>{autoApplySettings.locations?.join(", ") || "None"}</p>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-300">Platforms</p>
                        <p>{autoApplySettings.platforms?.join(", ") || "None"}</p>
                      </div>
                      <div>
                        <p className="font-semibold text-gray-300">Salary Range</p>
                        <p>
                          {autoApplySettings.salaryRange?.min}-{autoApplySettings.salaryRange?.max} LPA
                        </p>
                      </div>
                    </div>
                  </CardContent>
              ...
              <TabsContent value="analytics" className="space-y-4">
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-400">
                    Detailed analytics and insights about your auto-apply performance will be available here.
                  </p>
                </div>
              </TabsContent>
